...
export function DashboardBottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-50 border-t border-dashed border-[var(--dm-border-strong)] bg-dm-surface/96 px-1 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2 shadow-[0_-8px_24px_rgba(54,47,40,0.08)] lg:hidden"
    >
          ...
          return (
            <li key={item.href}>
              <Link
                ...
                prefetch
                className={[
                  "flex min-h-11 flex-col items-center justify-center rounded-md px-1 py-1 font-semibold transition-colors",
                  active
