      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex w-full flex-col gap-2 max-lg:mt-4 lg:max-w-none lg:flex-row lg:flex-wrap lg:justify-end lg:gap-2">
          <button
            ...
            className="hidden min-h-[44px] touch-manipulation lg:inline-flex dm-scan-hero items-center justify-center rounded-md px-4 py-2 text-sm font-semibold text-[#fffaf5] hover:brightness-105 disabled:pointer-events-none disabled:opacity-50"
          >
    ...
    >
      ...
      <div className="flex flex-wrap gap-2 pt-2">
        <button
          type="submit"
          disabled={pending}
          className="touch-manipulation max-lg:min-h-[44px] rounded-md bg-dm-electric px-4 py-2 text-sm font-semibold text-white hover:brightness-105 disabled:pointer-events-none disabled:opacity-55"
        >
        ...
        <button
          type="button"
          onClick={onCancel}
          className="touch-manipulation max-lg:min-h-[44px] rounded-md border border-[var(--dm-border-strong)] px-4 py-2 text-sm font-medium text-dm-muted hover:border-dm-electric hover:text-dm-text"
        >
          Cancel
        </button>
      </div>
